...
final class FournisseurController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('backoff/fournisseur/new.html.twig', [
    ...
    {
        return $this->render('backoff/fournisseur/show.html.twig', [
            'fournisseur' => $fournisseur,
        ]);
    }
    ...
    public function edit(Request $request, Fournisseur $fournisseur, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('backoff/fournisseur/edit.html.twig', [
            'fournisseur' => $fournisseur,
            'form' => $form,
        ]);
    }
