 ...
 */
class getInscriptionatelierRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\InscriptionatelierRepository' shared autowired service.
     *
     * @return \App\Repository\InscriptionatelierRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InscriptionatelierRepository.php';

        return $container->privates['App\\Repository\\InscriptionatelierRepository'] = new \App\Repository\InscriptionatelierRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
